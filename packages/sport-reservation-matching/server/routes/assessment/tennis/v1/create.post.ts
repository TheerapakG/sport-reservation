...
export default /*@__PURE__*/ effectEventHandler(handlerConfig)(() =>
  Effect.gen(function* () {
    ...
    yield* assessmentDbRepository.createTennisV1Assessment(userId, body);
