...
export default /*@__PURE__*/ effectEventHandler(handlerConfig)(() =>
  Effect.gen(function* () {
    ...
    yield* assessmentDbRepository.createRunningV1Assessment(userId, body);
