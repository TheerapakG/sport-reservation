...
import { getClubListInfiniteQueryOptions } from "@/api/club";
...
const ClubList = ({ className }: { className?: string }) => {
  const {
    data: clubsData,
    hasNextPage: clubsHasNextPage,
    fetchNextPage: clubsFetchNextPage,
    isFetchingNextPage: clubsIsFetchingNextPage,
  } = useSuspenseInfiniteQuery(
    getClubListInfiniteQueryOptions({
      limit: 10,
    }),
  );
...
export const Route = createFileRoute("/_layout/club/")({
